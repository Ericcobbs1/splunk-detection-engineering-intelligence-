...
def test_recommendations_handler_avoids_runtime_pep604_type_alias() -> None:
    source = Path("app/bin/dei/api/recommendations_handler.py").read_text(encoding="utf-8")
...
def test_knowledge_pack_loader_has_no_jsonschema_runtime_dependency() -> None:
    source = Path("app/bin/dei/knowledgepacks/loader.py").read_text(encoding="utf-8")
