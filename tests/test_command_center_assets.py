...
def test_command_center_view_is_valid_and_references_assets() -> None:
    ...
    assert root.attrib["script"] == (
        ...
        "environment_intelligence_v2.js,dei_environment_scan_v1.js,dei_workspace_layout_v6.js"
    )
    assert root.attrib["stylesheet"] == (
        "command_center_v2.css,environment_intelligence.css,environment_intelligence_v2.css,"
        "dei_visual_polish_v1.css,dei_workspace_layout_v1.css,dei_guided_tour_v2.css"
    )
    for element_id in (
...
def test_official_home_is_focused_on_pipeline_and_workspace_actions() -> None:
    ...
    assert root.attrib["script"] == "dei_environment_scan_v1.js,dei_lifecycle_store_v1.js,dei_workspace_layout_v5.js"
