...
def test_command_center_view_is_valid_and_references_assets() -> None:
    ...
    assert root.attrib["script"] == (
        ...
        "environment_intelligence_v2.js,dei_environment_scan_v1.js,dei_guide_adapter_v7.js,dei_workspace_layout_v14.js"
    )
...
def test_official_home_is_focused_on_pipeline_and_workspace_actions() -> None:
    ...
    assert root.attrib["script"] == "dei_environment_scan_v1.js,dei_lifecycle_store_v1.js,dei_guide_adapter_v7.js,dei_workspace_layout_v12.js,dei_home_globe_react_v1.js"
