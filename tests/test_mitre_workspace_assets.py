...
def test_mitre_workspace_view_is_valid_and_contained() -> None:
    ...
    assert root.attrib["script"] == "mitre_workspace_v3.js,dei_environment_scan_v1.js,dei_interactive_guide_v1.js,dei_guide_adapter_v1.js,dei_workspace_layout_v12.js"
