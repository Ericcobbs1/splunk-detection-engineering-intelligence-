  ...
  return (
    <section className="dei-next-guide" role="dialog" aria-modal="false" aria-labelledby="dei-guide-title" aria-describedby="dei-guide-instruction">
      ...
      <div className="dei-next-guide-action">
        ...
        <div><small>Do this now</small><strong>{step.actionLabel}</strong></div>
      </div>
      <div className="dei-next-guide-status" role="status" aria-live="polite">
        <i aria-hidden="true" /> Waiting for this action to complete
      </div>
      ...
      <footer className="dei-next-guide-footer">
        ...
        <Button appearance="primary" onClick={onFocusTarget}>Show me</Button>
      </footer>
      <p className="dei-next-guide-hint">The guide advances automatically after you complete the highlighted action. Press Esc to exit.</p>
    </section>
  );
}
